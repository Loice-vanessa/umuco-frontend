  ...
  return (
    <>
      <div className="home-container">
        ...
        <div className="site-card-wrapper">
          <Card.Grid className="site-card">
            ...
            <h3 bold> MEMBERS </h3>
            <p>
              When you join the Umuco Community, we invest in your education and
          ...
          <Card.Grid className="site-card">
            ...
            <p>
              Investing in Umuco Community is a big opportunity and we have many
              options for you to get involved and impact lives.
            </p>
            <h4>Read more</h4>
          </Card.Grid>
      ...
      >
        ...
        <div className="AmasunzuCard">
          <img src={ingoma} alt="" className=""></img>
          <Card
            style={{
              width: 500,
            }}
        ...
        <div className="knowMore">
          <h5>Did you know</h5>
          <FaQuoteLeft
            style={{ color: "gold", fontSize: "34px", marginTop: "20px" }}
          />
          <ul>
            <li>
              Rwanda attaches great importance to the preservation and promotion
              of its culture as a cornerstone for sustainable development.
