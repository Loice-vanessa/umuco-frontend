    ...
    <>
      ...
      <div style={{ display: "flex", margin: "120px", paddingLeft: "80px" }}>
        ...
        <p>
          ...
          exposure to native speakers, <br /> you may need to book a private class
          where you will get a dedicated coach <br />to guide your learning journey.
          If you are an intuitive learner or if you often<br /> speak to native
          speakers, an online plan would be all you need to get started. <br />You may
          learn along videos and practice pronunciations using audios.
        </p>
      </div>
      <div style={{ display: "flex", margin: "120px", paddingLeft: "80px" }}>
        <p>
          ...
          <br />
          in learning, reading and languages.
          He speaks four languanges including <br /> Chinese Mandarin. 
          He has been coached by Denyse and is ready <br />
          to lead your Kinyarwanda learning Journey.
          <h3>How it works</h3> 
           If you have been in Rwanda
          for a while, assuming that you know greetings, <br />numbers, food, etc.;
          you can read the intermediate level course with <br />audio (no videos yet).
          This will enhance both your grammar and vocabulary.<br /> If you are not
          sure, please book a free appointment and <br />we will be happy to help you
          figure it out.
        </p>
